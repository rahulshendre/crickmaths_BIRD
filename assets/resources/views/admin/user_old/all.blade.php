  ...
  <div class="content-header row">
    <div class="content-header-left col-md-9 col-12 mb-2">
      <div class="row breadcrumbs-top">
        <div class="col-12">
           <h4 class="card-title" style="color:  #880808;">All User</h4>
  ...
  <div class="row">
    <div class="col-12" >
      <div class="card">
        ...
        <a href="{{config('app.baseURL')}}/admin/user/add" > <button type="submit" class="btn pull-right btn btn-primary panel-button add-btn">Add User</button></a><br>
...
$(document).ready( function () {
    var table = $('#data-table').DataTable({
        ...
        columns: [
           ...
           {"targets":-1,
             ...
             "mRender": function(data, type, row){
              return "<a class=datatable-left-link href={{config('app.baseURL')}}/admin/user/edit/" + row.id+"><span><button type='submit' class='btn btn-primary mr-1'>Edit</button></span></a>";
        ...
        {"targets":-1,
             ...
             "ilter":false,
             "mRender": function(data, type, row){
              return "<a class=datatable-left-link href={{config('app.baseURL')}}/admin/user/delete/" + row.id+"><span><button type='submit' class='btn btn-danger mr-1'>Delete</button></span></a>";
         ...
         {"targets":-1,
             ...
             "ilter":false,
             "mRender": function(data, type, row){
              return "<a class=datatable-left-link href={{config('app.baseURL')}}/admin/rank/all/" + row.id+"><span><button type='submit' class='btn btn-primary mr-1'>Rank</button></span></a>";
