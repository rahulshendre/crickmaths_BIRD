  ...
  <div class="content-header row">
    <div class="content-header-left col-md-9 col-12 mb-2">
      <div class="row breadcrumbs-top">
        <div class="col-12">
           <h4 class="card-title" style="color:  #880808;">All Level</h4>
  ...
  <div class="row">
    <div class="col-12" >
      <div class="card">
        ...
        <a href="{{config('app.baseURL')}}/admin/level/add" > <button type="submit" class="btn pull-right btn btn-primary panel-button add-btn">Add Level</button></a><br>
...
$(document).ready( function () {
    var table = $('#data-table').DataTable({
        ...
        processing: true,
        serverSide: true,
        ajax: "{{config('app.baseURL')}}/admin/level/allData",
        columns: [
           ...
           {"targets":-1,
             ...
             "mRender": function(data, type, row){
              return "<a class=datatable-left-link href={{config('app.baseURL')}}/admin/level/edit/" + row.level_id+"><span><button type='submit' class='btn btn-primary mr-1'>Edit</button></span></a>";
             ...
             "mRender": function(data, type, row) {
             if(row.is_active==0){
              return "<a class=datatable-left-link href={{config('app.baseURL')}}/admin/level/active/" + row.level_id+"><span><button type='submit' class='btn btn-danger '> Inactivate</button></span></a>";
              
            }
            
            else{
              return "<a class=datatable-left-link href={{config('app.baseURL')}}/admin/level/inactive/" + row.level_id+"><span><button type='submit' class='btn btn-success'>Activate</button></span></a>";
               }
            },
          },
