...
<body>
	<div class="container-fluid">
					...
					<div class="page-header">
						<div>
							<h2 class="main-content-title tx-24 mg-b-5"> Add Inquiry</h2>
							<ol class="breadcrumb">
					...
					<div class="row">
						<div class="col-lg-12 col-md-12">
							<div class="card custom-card">
								<div class="card-body">
									<div>
										<h6 class="card-title mb-1">Add Inquiry</h6>
                    ...
                    @endif
										...
										<div class="col-md-10">
												<div class="form-group">
													...
													<input class="form-control" name="message"  type="text" placeholder=" Enter Message">
												</div>
											</div>
