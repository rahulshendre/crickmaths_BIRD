    ...
    <div class="col-12">
      <div class="card">
        ...
        <div style="margin-top:1%;">
            <a href="{{config('app.baseURL')}}/admin/question/add"><button class="btn btn-primary" type="button" style=" float: inline-end;">Add Question</button></a>
        </div>
        ...
        columns: [
           ...
           return ch;
            ...
            {"targets":-1,
             ...
             "mRender": function(data, type, row) {
             if(row.is_active==0){
              return "<a class=datatable-left-link href={{config('app.baseURL')}}/admin/question/inactive/" + row.question_id+"><span><button type='submit' class='btn btn-success'>Activate</button></span></a>";
              
            }
            
            else{
              return "<a class=datatable-left-link href={{config('app.baseURL')}}/admin/question/active/" + row.question_id+"><span><button type='submit' class='btn btn-danger'>Inactivate</button></span></a>";
               }
            },
          },
          ...
          {"targets":-1,
             ...
             "mRender": function(data, type, row) {
               ...
               return "<a class=datatable-left-link href={{config('app.baseURL')}}/admin/question/update/" + row.question_id+"><span><button type='submit' class='btn btn-primary'>Update</button></span></a>";
