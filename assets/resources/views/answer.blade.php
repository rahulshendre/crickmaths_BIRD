...
scoreboardHTML +='<h3 class="score-message orange" >questions correctly.</h3></div>'
          ...
          if (percentage >= 0.9) {
            scoreboardHTML += '<div class="score-botom"><h6 class="pink"> <img src="{{config('app.baseURL')}}/assets/v/MASCOT with trophy-01.png"> Incredible! Awesome job!</h6>';
          } else if (percentage >= 0.7) {
            scoreboardHTML += '<div class="score-botom"><h6 class="pink"></h6>';
          } else if (percentage >= 0.5) {
            scoreboardHTML += '<div class="score-botom"><h6 class="pink"> Not bad! Keep it up! <img src="{{config('app.baseURL')}}/assets/v/mascot-all the best-01.png"></h6>';
          } else {
            scoreboardHTML += '<div class="score-botom"><h6 class="pink"> Better luck next time! <img src="{{config('app.baseURL')}}/assets/v/mascot- umpire-02.png"></h6>';
          }
