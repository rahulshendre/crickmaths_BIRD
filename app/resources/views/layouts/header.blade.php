...
<header class="vs-header header-layout2">
 ...
 <li><a href="{{config('app.baseURL')}}/logout">Logout</a></li>
 <li><a href="{{config('app.baseURL')}}/profile">My Profile</a></li>
 @else
  <li><a href="{{config('app.baseURL')}}/login">Login</a></li>
             <li>
<a href="{{config('app.baseURL')}}/register">Sign up</a>
</li>
 @endif
                    </ul>
                </div>
