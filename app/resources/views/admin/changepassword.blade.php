...
<body>
  <div class="container-fluid">
          ...
          <!-- Row -->
          <form class="form-horizontal" role="form" method="POST" action="{{config('app.baseURL')}}/admin/user/change-password/{{$id}}" enctype="multipart/form-data"  onsubmit="return validateForm()">
                                @csrf
