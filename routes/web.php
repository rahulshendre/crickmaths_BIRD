...
Route::get('gallery','PublicController@getGallery');
...
Route::post('playnow','PublicController@postPlayNow')->name('playnow');


Route::get('check-username/{username}','PublicController@checkUsername');
...
Route::get('howzzat','PublicController@getHowzzat');
Route::get('pavilion','PublicController@getPavilion');

Route::get('cricketlingo','PublicController@getCricketlingo');


Route::get('user-dashboard','PublicController@getUserDashboard');

Route::get('user-score-recored','PublicController@getUserScoreRecord');
...
Route::get('edit-profile','PublicController@getUserDashboard');
...
Route::get('gettrivo', ['middleware' =>'auth', 'uses' =>'PublicController@gettrivo']);
...
Route::get('practice/play', 'PracticeController@play')->name('practice.play');
...
Route::get('admin/teacher/all', ['middleware' =>'auth', 'uses' =>'TeacherController@getAllTeacher']);
Route::get('admin/teacher/allData', ['middleware' =>'auth', 'uses' =>'TeacherController@getAllTeacherData']);

Route::get('admin/teacher/add', ['middleware' =>'auth', 'uses' =>'TeacherController@getAddteacher']);
