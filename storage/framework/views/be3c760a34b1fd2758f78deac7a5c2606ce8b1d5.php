...
<div class="practice-container">
    ...
    <br>
    <a href="<?php echo e(url('/')); ?>" class="back-btn">Back to Home</a>
</div>
...
$(document).ready(function() {
    ...
    $('#startBtn').on('click', function() {
        ...
        $.ajax({
            url: '<?php echo e(route("practice.start")); ?>',
            method: 'POST',
            data: {
                grade: selectedGrade,
            ...
            success: function(response) {
                ...
                window.location.href = '<?php echo e(url("/practice/play")); ?>';
            },
            error: function(xhr) {
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/rahulshendre/Desktop/Coding/PlanetRead/Crickmath/cricmaths.billionreaders.org/resources/views/practice/index.blade.php ENDPATH**/ ?>