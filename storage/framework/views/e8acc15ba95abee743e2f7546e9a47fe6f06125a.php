...
<style>
    .banner-image-section {
        background-image: url('<?php echo e(asset('assets/img/pavilion/bg_img.png')); ?>');
...
*/            background: url('<?php echo e(asset('assets/img/pavilion/bg3.png')); ?>') no-repeat center;
...
*/           background: url('<?php echo e(asset('assets/img/pavilion/bg4.png')); ?>') no-repeat center;
...
*/           width: 9%;
        ...
        .profile-left"{
                  background-image: url('<?php echo e(asset('assets/img/pavilion/bg1.png')); ?>');
...
/*.math-text{
        ...
        background-image: url('<?php echo e(asset('assets/img/pavilion/union.png')); ?>');
...
<!--                         <img src="<?php echo e(config('app.baseURL')); ?>/assets/img/pavilion/ball.png" class="ball" alt="Cricket Stumps" >
 -->
        <!--  <div class="row" style="    justify-content: space-between;">

            <img src="<?php echo e(config('app.baseURL')); ?>/assets/img/pavilion/stump_left.png" class="stump_left" alt="Cricket Stumps" >
                            <img src="<?php echo e(config('app.baseURL')); ?>/assets/img/pavilion/stump_right.png" class="stump_right" alt="Cricket Stumps" >

        </div> -->

        <img src="<?php echo e(config('app.baseURL')); ?>/assets/img/pavilion/union.png" class="bg_white" alt="Cricket bat"">
                ...
                <img src="<?php echo e(config('app.baseURL')); ?>/assets/mascot/mascot-winner.png" class="cartton" alt="Cricket bat" >
...
<section class="team-section">
        ...
        <div class="container">
            <div class="profile-card">
                  <img src="<?php echo e(config('app.baseURL')); ?>/assets/img/pavilion/bg1.png" alt="Person 1">
<img src="<?php echo e(config('app.baseURL')); ?>/assets/img/pavilion/person1.png" alt="Person 1" style="margin-left: -14%; margin-top: -3%;">
                ...
                <img src="<?php echo e(config('app.baseURL')); ?>/assets/img/pavilion/bg2.png" alt="Person 1" style="margin-right: -10%;     margin-top: -3%;">
                <img src="<?php echo e(config('app.baseURL')); ?>/assets/img/pavilion/person2.png" alt="Person 2" style="margin-right: -7%; margin-bottom: -19px;">
            </div>

            <!-- Second Content Block: Cricket Illustration and Text -->
            <div class="icon-box">
                <img src="<?php echo e(config('app.baseURL')); ?>/assets/img/pavilion/play1.png" alt="Cricket Icon" >
                <div class="icon-text">
                <p class="m-0">
                ...
                <img src="<?php echo e(config('app.baseURL')); ?>/assets/img/pavilion/trophy.png" class="trophy" alt="Trophy Icon">

            </div>
             <img src="<?php echo e(config('app.baseURL')); ?>/assets/img/pavilion/grass.png" class="grass_one" alt="Trophy Icon">

             <img src="<?php echo e(config('app.baseURL')); ?>/assets/img/pavilion/grass.png" class="grass_two" alt="Trophy Icon">
             <img src="<?php echo e(config('app.baseURL')); ?>/assets/img/pavilion/grass.png" class="grass_three" alt="Trophy Icon">


            <!-- Grass Border -->
            <div class="grass-border">
            </div>
            <img src="<?php echo e(config('app.baseURL')); ?>/assets/img/BBXLogo.png" style="
  ...
  <div class="container" >
    ...
    <div class="row">
      ...
      <div class="col-md-2 d-none d-md-block">
      	<img src="<?php echo e(config('app.baseURL')); ?>/assets/img/pavilion/line.png" alt="divider Image" class="character-img" style="        height: 70%;"> <!-- Your character image -->
      </div>
      <div class="col-md-5">
        <div class="vision-card">
...
<section class="play-cricket-section">
	...
	<div class="container" style="    text-align: center; ">
			<a href="<?php echo e(config('app.baseURL')); ?>/after-start"><button class="btn btn-primary" style="background: #FFFFFF; color: #B70303; border-radius: 23px; border-color: #FFFFFF;">Play Cricket</button></a>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/billionreaders-cricmaths/htdocs/cricmaths.billionreaders.org/resources/views/pavilion.blade.php ENDPATH**/ ?>