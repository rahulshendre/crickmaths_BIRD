...
<!-- 		<link rel="stylesheet" href="<?php echo e(config('app.baseURL')); ?>/assets/bootstrap/css/bootstrap.min.css">
 -->
		<!-- Favicon -->
...
<!-- 		<title>Dashlead -  Admin Panel HTML Dashboard Template</title>
 -->
	    ...
	    <script src="<?php echo e(config('app.baseURL')); ?>/assets/js/jquery-1.12.4.min.js"></script>
		<script src="<?php echo e(config('app.baseURL')); ?>/assets/js/jquery.countdown.min.js"></script>
		<script src="<?php echo e(config('app.baseURL')); ?>/assets/js/jquery.counterup.min.js"></script>




		<!-- Jquery js-->
		<script src="<?php echo e(config('app.baseURL')); ?>/admin-assets/plugins/jquery/jquery.min.js"></script>
...
<!-- 		<link href="admin-assets/plugins/ionicons/css/ionicons.min.css" rel="stylesheet">
 -->
		...
		<!---Select2 css-->
<link href="<?php echo e(config('app.baseURL')); ?>/admin-assets/plugins/select2/css/select2.min.css" rel="stylesheet">
<!--Mutipleselect css-->
<link rel="stylesheet" href="<?php echo e(config('app.baseURL')); ?>/admin-assets/plugins/multipleselect/multiple-select.css">
<!---Jquery.mCustomScrollbar css-->
<link href="<?php echo e(config('app.baseURL')); ?>/admin-assets/plugins/jquery.mCustomScrollbar/jquery.mCustomScrollbar.css" rel="stylesheet">
		...
		<link href="<?php echo e(config('app.baseURL')); ?>/admin-assets/switcher/demo.css" rel="stylesheet">	</head>
...
<?php echo $__env->make('layouts.admin_manu', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<!-- Jquery-Ui js-->
<script src="<?php echo e(config('app.baseURL')); ?>/admin-assets/plugins/jquery-ui/ui/widgets/datepicker.js"></script>
		<!-- Bootstrap js-->
		...
		<!-- Flot Chart js-->
<script src="<?php echo e(config('app.baseURL')); ?>/admin-assets/plugins/jquery.flot/jquery.flot.js"></script>
<script src="<?php echo e(config('app.baseURL')); ?>/admin-assets/plugins/jquery.flot/jquery.flot.resize.js"></script>
<script src="<?php echo e(config('app.baseURL')); ?>/admin-assets/js/chart.flot.sampledata.js"></script>
<!-- Chart.Bundle js-->
<script src="<?php echo e(config('app.baseURL')); ?>/admin-assets/plugins/chart.js/Chart.bundle.min.js"></script>
<!-- Peity js-->
<script src="<?php echo e(config('app.baseURL')); ?>/admin-assets/plugins/peity/jquery.peity.min.js"></script>

<!-- Select2 js-->
<script src="<?php echo e(config('app.baseURL')); ?>/admin-assets/plugins/select2/js/select2.min.js"></script>
<!--MutipleSelect js-->
<script src="<?php echo e(config('app.baseURL')); ?>/admin-assets/plugins/multipleselect/multiple-select.js"></script>
<script src="<?php echo e(config('app.baseURL')); ?>/admin-assets/plugins/multipleselect/multi-select.js"></script>
<!-- Jquery.mCustomScrollbar js-->
<script src="<?php echo e(config('app.baseURL')); ?>/admin-assets/plugins/jquery.mCustomScrollbar/jquery.mCustomScrollbar.concat.min.js"></script>
<!-- index -->
<script src="<?php echo e(config('app.baseURL')); ?>/admin-assets/js/index.js"></script>
...
</html>		<?php /**PATH /home/vebsignsn/public_html/cricmaths/resources/views/layouts/admin_app.blade.php ENDPATH**/ ?>