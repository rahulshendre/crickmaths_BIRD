...
.custom-section::before {
    content: "";
      background: url('<?php echo e(asset('assets/img/howzzat/vector.png')); ?>') no-repeat center;
    background-size: cover;
    position: absolute;
    top: 0;
    right: 0;
...
<section style="background: white; margin: 0; padding: 0;"> 
  <div class="container-fluid p-5 text-center custom-banner">
      <div class="row icon-container" style="background: #F2F2F2;">
        <div class="col-md-2">
          <img src="<?php echo e(config('app.baseURL')); ?>/assets/img/howzzat/batball.png" class="batball-banner-image" alt="Cricket Bat Ball">
        </div>
        <div class="col-md-8 center-image-div">
          <div class="text-center">
            <div class="howzzat-work" style="display:flex; align-items: flex-end;">
              <img src="<?php echo e(config('app.baseURL')); ?>/assets/mascot/mascot-bowling.png" class="center-image" alt="Bunny Icon">
        ...
        <div class="col-md-2 banner-stump-image">
          <img src="<?php echo e(config('app.baseURL')); ?>/assets/img/howzzat/stump.png" class="banner-image" alt="Cricket Stumps">
        </div>
      </div>
  </div>
</section>
...
<!-- <section style="background: white; margin: 0; padding: 0;"> 
  <div class="container-fluid p-5 text-center custom-banner">
      <div class="row icon-container" style="background: #F2F2F2;">
        <div class="col-md-2">
          <img src="<?php echo e(config('app.baseURL')); ?>/assets/img/howzzat/batball.png" class="batball-banner-image" alt="Cricket Bat Ball" style="width: 25%;">
        </div>
        <div class="col-md-8">
          <div class="text-center">
            <div style="display:flex; align-items: flex-end;">
              <img src="<?php echo e(config('app.baseURL')); ?>/assets/img/howzzat/cartton.png" class="center-image" alt="Bunny Icon" style="width:35%;height: ;">
              <h1 class="custom-heading">Howzzat! Work?</h1>
            </div>
        ...
        <div class="col-md-2">
          <img src="<?php echo e(config('app.baseURL')); ?>/assets/img/howzzat/stump.png" class="banner-image" alt="Cricket Stumps" style="width:15%;">
        </div>
      </div>
  </div>
</section> -->
...
<section style="background: white; margin: 0; padding: 0;"> <!-- Removed margin and padding -->
  <div class="container custom-section"> 
    ...
    <div class="step-list">
      ...
      <a href="<?php echo e(config('app.baseURL')); ?>/after-start"><button class="play-button">PLAY</button></a>
    </div>
    </div>

    <div class="col-md-4">
    <div class="image-container">
      <img src="<?php echo e(config('app.baseURL')); ?>/assets/mascot/mascot-batting.png" alt="Cricket Playing Boy">
    </div>
  </div>
  </div>
  </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/rahulshendre/Desktop/Coding/PlanetRead/Crickmath/cricmaths.billionreaders.org/resources/views/howzzat.blade.php ENDPATH**/ ?>