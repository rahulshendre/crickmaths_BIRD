...
<body>
        ...
        <div class="container-fluid" id="dashtop">
          ...
          <div class="row row-sm">
              ...
              <div class="card custom-card">
                <div class="card-body text-center">
                  <div class="icon-service bg-secondary-transparent rounded-circle text-secondary">
                    <p class="text-center"><?php echo e($question); ?><p>
                  </div>
            ...
            <div class="col-sm-6 col-md-3 col-xl-6">
              <div class="card custom-card">
                <div class="card-body text-center">
                  <div class="icon-service bg-secondary-transparent rounded-circle text-secondary"><p style="margin: auto;font-size: 19px;"><?php echo e($student); ?></p>
           ...
           <div class="row row-sm">
            <div class="col-sm-4 col-md-3 col-xl-4">
              <div class="card custom-card">
                <div class="card-body text-center">
                  <div class="icon-service bg-secondary-transparent rounded-circle text-secondary">
                    <p class="text-center"><?php echo e($user); ?><p>
                  </div>
            ...
            <div class="col-sm-4 col-md-3 col-xl-4">
              <div class="card custom-card">
                <div class="card-body text-center">
                  <div class="icon-service bg-secondary-transparent rounded-circle text-secondary"><p style="margin: auto;font-size: 19px;"><?php echo e($teacher); ?></p>
                    <!-- <i class="fa fa-rupee" aria-hidden="true"></i> -->
                  </div>
            ...
            <div class="col-sm-4 col-md-3 col-xl-4">
              <div class="card custom-card">
                <div class="card-body text-center">
                  <div class="icon-service bg-secondary-transparent rounded-circle text-secondary"><p style="margin: auto;font-size: 19px;"><?php echo e($current_month_count); ?></p>
                    <!-- <i class="fa fa-rupee" aria-hidden="true"></i> -->
                  </div>
  ...
  <script src="<?php echo e(config('app.baseURL')); ?>/assets/plugins/peity/jquery.peity.min.js"></script>
  <script src="https://laravel.spruko.com/dashlead/Leftmenu-Icon-Light/assets/plugins/jquery.flot/jquery.flot.pie.js"></script>
   ...
   <!--  <script>
        ...
        const uniqueCounts = <?php echo json_encode($monthlyUniqueCounts, 15, 512) ?>;
    ...
    const months = <?php echo json_encode($months, 15, 512) ?>;  // Data for months
    const monthlyUniqueCounts = <?php echo json_encode($monthlyUniqueCounts, 15, 512) ?>;  // Monthly data for unique users
    ...
    const weeks = <?php echo json_encode($weeks, 15, 512) ?>;  // Data for weeks
    const weeklyUniqueCounts = <?php echo json_encode($weeklyUniqueCounts, 15, 512) ?>;  // Weekly data for unique users
...
<?php echo $__env->make('layouts.admin_app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vebsignsn/public_html/cricmaths/resources/views/admin/dashboard.blade.php ENDPATH**/ ?>