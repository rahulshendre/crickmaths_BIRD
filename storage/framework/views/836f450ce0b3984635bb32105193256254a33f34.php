...
text-align: center;
    ...
    color: #FFFFFF;
        ...
        .term-card {
background: url('<?php echo e(asset('assets/img/cricket_lingo/bg.png')); ?>') no-repeat center;           
 border-radius: 20px;
...
<section class="pavilion">
        ...
        <div class="term-card">
            ...
            <img src="<?php echo e(config('app.baseURL')); ?>/assets/img/cricket_lingo/ellipse.png" class="cricket-bat" alt="Cricket bat" style="    width: 20%;"> 
<h3>Batsman</h3></div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/rahulshendre/Desktop/Coding/PlanetRead/Crickmath/cricmaths.billionreaders.org/resources/views/cricketlingo.blade.php ENDPATH**/ ?>