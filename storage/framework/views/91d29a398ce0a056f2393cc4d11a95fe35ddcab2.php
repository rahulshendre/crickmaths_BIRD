...
@media (min-width: 1919px) and (max-width: 2050px){
...
<p>Let’s show you how to be a CricMaths Champ</p>
      ...
      <a href="<?php echo e(config('app.baseURL')); ?>/howzzat"><div class="howzzat" style="background-color:#459F01;;">
          <h3>Howzzat! Work?</h3>
      </div></a>
...
<?php if($key == 0): ?>
               <h3 class="vs-tem">vs</h3>              
                        <?php endif; ?>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <a href="<?php echo e(config('app.baseURL')); ?>/after-start"><button class="btn btn-danger">Play</button></a>
                </div>
        ...
        <div class="container text-center">
            ...
            <?php if(!$hasValidMatches): ?>
                <div class="text-center py-5">
                    ...
                    <a href="<?php echo e(route('practice.index')); ?>" class="btn btn-danger btn-lg" style="background-color: #b70303; padding: 15px 40px; font-size: 1.3rem; border-radius: 30px; font-weight: 600; font-family: 'Baloo Da 2', sans-serif;">
                        🎯 Practice Mode
                    </a>
                </div>
            <?php endif; ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/rahulshendre/Desktop/Coding/PlanetRead/Crickmath/cricmaths.billionreaders.org/resources/views/index.blade.php ENDPATH**/ ?>