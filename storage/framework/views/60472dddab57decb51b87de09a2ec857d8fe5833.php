    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="form-style3">
                <div ><h4><?php echo e(__('Reset Password')); ?></h4></div>

                <div class="card-body">
                    <form method="POST" action="postReset">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vebsignsn/public_html/cricmaths/resources/views/auth/passwords/reset.blade.php ENDPATH**/ ?>