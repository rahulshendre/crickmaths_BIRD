  ...
  <div class="content-header row">
    <div class="content-header-left col-md-9 col-12 mb-2">
      <div class="row breadcrumbs-top">
        <div class="col-12">
           <h4 class="card-title" style="color:  #880808;">All Inquiry</h4>
  ...
  <div class="row">
    <div class="col-12" >
      <div class="card">
        ...
        <a href="{{config('app.baseURL')}}/admin/inquiry/add" > <button type="submit" class="btn pull-right btn btn-primary panel-button add-btn">Add Inquiry</button></a><br>
...
$(document).ready( function () {
    var table = $('#data-table').DataTable({
        ...
        processing: true,
        serverSide: true,
        ajax: "{{config('app.baseURL')}}/admin/inquiry/allData",
        columns: [
        ...
        {"targets":-1,
             ...
             "mRender": function(data, type, row){
              return "<a class=datatable-left-link href={{config('app.baseURL')}}/admin/inquiry/delete/" + row.id+"><span><button type='submit' class='btn btn-danger mr-1'>Delete</button></span></a>";
