...
@endif
    ...
    <div class="row mb-3">
        ...
        <div class="col-md-6">
<input id="username" pattern="^[a-zA-Z0-9]+$" type="text" class="form-control @error('username') is-invalid @enderror" name="username" value="{{ old('username') }}" required autocomplete="username" autofocus onkeyup="checkUsernameExistence()">
