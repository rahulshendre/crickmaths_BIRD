...
<body>
	<div class="container-fluid">
					...
					<div class="page-header">
						<div>
							<h2 class="main-content-title tx-24 mg-b-5"> Add Level</h2>
							<ol class="breadcrumb">
					...
					<div class="row">
						<div class="col-lg-12 col-md-12">
							<div class="card custom-card">
								<div class="card-body">
									<div>
										<h6 class="card-title mb-1">Add Level</h6>
										...
										<div class="row">
											<div class="col-md-4">
												<div class="form-group">
													...
													<input class="form-control" name="level_name" required="" type="text" placeholder="Enter Name">
												</div>
											</div>
